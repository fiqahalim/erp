...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('admin.settings.currencies.create.header.before') !!}
        ...
        <div class="page-header">
            ...
            <div class="page-title">
                <h1>{{ __('admin::app.currencies.create-title') }}</h1>
            </div>
        </div>

        {!! view_render_event('admin.settings.currencies.create.header.after') !!}

        <form method="POST" action="{{ route('admin.settings.currencies') }}" @submit.prevent="onSubmit">
